...
\begin{document}
    ...
    \title{Breaking Trivium with a Single Fault \\
    }
...
The \code{UPDATE()} macro is used in the \code{ECRYPT_ivsetup} and \code{ECRYPT_process_bytes} functions. This means that when disassembling the \code{trivium.o} object file 
